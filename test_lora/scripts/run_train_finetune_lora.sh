...
TRAIN_ARGS=(
    ...
    "--test_dataset" "10 @ MapFree(split='train', ROOT='$DATASET_PATH/', resolution=[(512, 288)], seed=777)"
...
for SUFFIX in "${SUFFIXES[@]}"; do
    ...
    ln -s "${DATASET_PATH}/finetune/pairs/mapfree_pairs_${SUFFIX}.npy" "${DATASET_PATH}/finetune/mapfree_pairs.npy"
    ...
    # Post-processing
    rm "$OUTPUT_DIR"/*.pth
    cp "$OUTPUT_DIR/lora.pt" "${DATASET_PATH}/finetune/weights/duster_lora_${SUFFIX}.pt"
    rm "${DATASET_PATH}/finetune/mapfree_pairs.npy"
