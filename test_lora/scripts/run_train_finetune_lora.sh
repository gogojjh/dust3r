...
for SUFFIX in "${SUFFIXES[@]}"; do
    ...
    ln -s "${DATASET_PATH}/finetune_duster_calib_pretrain/pairs/mapfree_pairs_${SUFFIX}.npy" "${DATASET_PATH}/train/mapfree_pairs.npy"
    ...
    # Post-processing
    rm "$OUTPUT_DIR"/*.pth
    cp "$OUTPUT_DIR/lora.pt" "${DATASET_PATH}/finetune_duster_calib_pretrain/weights/duster_lora_${SUFFIX}.pt"
    rm "${DATASET_PATH}/train/mapfree_pairs.npy"
